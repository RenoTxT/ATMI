    ...
    for (int i = 0; i < dataa; ++i) {
        if (arrayLOMBA[i].nama == cariLomba) 
        {
            if (arrayLOMBA[i].maxPeserta > 0)                    //peraturan lomba
            {
                ...
                cout << "2. Karya yang di lombakan merupakan karya asli dan tidak mengandung plagiarisme" << endl;
                cout << "3. Karya yang di lombakan belum pernah di publikasikan atau dilombakan. " << endl;
                cout << "4. Peserta wajib menaati peraturan yang ada" << endl;
                cout << "5. Bersedia membayar uang pendaftaran sebesar Rp " << arrayLOMBA[i].harga << endl;
                cout << "===============================" << endl << endl;
